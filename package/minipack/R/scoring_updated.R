...
scoring_updated <- function(evaluate, bd = bayesian_data){
  ...
  if(is.na(eval[,"alpha"])){
    ...
    alpha[[1]]$chi[eval[,"chi"]] * alpha[[1]]$total / chi[[eval[,"chi"]]]$total))
  }else if(eval[,"alpha"]+1 <= 36){
    ...
    alpha[[eval[,"alpha"]+1]]$chi[eval[,"chi"]] * alpha[[eval[,"alpha"]+1]]$total / chi[[eval[,"chi"]]]$total))
  ...
  if(is.na(eval[,"alpha"])){
    ...
    alpha[[36]]$chi[eval[,"chi"]] * alpha[[36]]$total / chi[[eval[,"chi"]]]$total))
  }else if(eval[,"alpha"]-1 >=1){
  ...
  if(is.na(eval[,"beta"])){
    ...
    beta[[1]]$chi[eval[,"chi"]] * beta[[1]]$total / chi[[eval[,"chi"]]]$tota))
  }else if(eval[,"beta"]+1 <= 36){
    ...
    beta[[eval[,"beta"]+1]]$chi[eval[,"chi"]] * beta[[eval[,"beta"]+1]]$total / chi[[eval[,"chi"]]]$total))
  }
  ...
  if(is.na(eval[,"beta"])){
    ...
    beta[[36]]$chi[eval[,"chi"]] * beta[[36]]$total / chi[[eval[,"chi"]]]$total))
  }else if(eval[,"beta"]-1 >=1){
    amt <- append(amt, c(beta[[eval[,"beta"]-1]]$alpha[eval[,"alpha"]] * beta[[eval[,"beta"]-1]]$total / alpha[[eval[,"alpha"]]]$total,
    beta[[eval[,"beta"]-1]]$gamma[eval[,"gamma"]] * beta[[eval[,"beta"]-1]]$total / gamma[[eval[,"gamma"]]]$total,
    beta[[eval[,"beta"]-1]]$delta[eval[,"delta"]] * beta[[eval[,"beta"]-1]]$total / delta[[eval[,"delta"]]]$total,
  ...
  if(is.na(eval[,"gamma"])){
    ...
    gamma[[1]]$chi[eval[,"chi"]] * gamma[[1]]$total / chi[[eval[,"chi"]]]$total))
  }else if(eval[,"gamma"]+1 <= 36){
    ...
    gamma[[eval[,"gamma"]+1]]$chi[eval[,"chi"]] * gamma[[eval[,"gamma"]+1]]$total / chi[[eval[,"chi"]]]$total))
  }
  ...
  if(is.na(eval[,"gamma"])){
    ...
    gamma[[36]]$chi[eval[,"chi"]] * gamma[[36]]$total / chi[[eval[,"chi"]]]$total))
  }else if(eval[,"gamma"]-1 >=1){
    amt <- append(amt, c(gamma[[eval[,"gamma"]-1]]$alpha[eval[,"alpha"]] * gamma[[eval[,"gamma"]-1]]$total / alpha[[eval[,"alpha"]]]$total,
    gamma[[eval[,"gamma"]-1]]$beta[eval[,"beta"]] * gamma[[eval[,"gamma"]-1]]$total / beta[[eval[,"beta"]]]$total,
    gamma[[eval[,"gamma"]-1]]$delta[eval[,"delta"]] * gamma[[eval[,"gamma"]-1]]$total / delta[[eval[,"delta"]]]$total,
  ...
  if(is.na(eval[,"delta"])){
    ...
    delta[[1]]$chi[eval[,"chi"]] * delta[[1]]$total / chi[[eval[,"chi"]]]$total))
  }else if(eval[,"delta"]+1 <= 36){
    ...
    delta[[eval[,"delta"]+1]]$chi[eval[,"chi"]] * delta[[eval[,"delta"]+1]]$total / chi[[eval[,"chi"]]]$total))
  }
  ...
  if(is.na(eval[,"delta"])){
    ...
    delta[[36]]$chi[eval[,"chi"]] * delta[[36]]$total / chi[[eval[,"chi"]]]$total))
  }else if(eval[,"delta"]-1 >=1){
    amt <- append(amt,  c(delta[[eval[,"delta"]-1]]$alpha[eval[,"alpha"]] * delta[[eval[,"delta"]-1]]$total / alpha[[eval[,"alpha"]]]$total,
    delta[[eval[,"delta"]-1]]$beta[eval[,"beta"]] * delta[[eval[,"delta"]-1]]$total / beta[[eval[,"beta"]]]$total,
    delta[[eval[,"delta"]-1]]$gamma[eval[,"gamma"]] * delta[[eval[,"delta"]-1]]$total / gamma[[eval[,"gamma"]]]$total,
  ...
  if(is.na(eval[,"epsilon"])){
    ...
    epsilon[[1]]$chi[eval[,"chi"]] * epsilon[[1]]$total / chi[[eval[,"chi"]]]$total))
  }else if(eval[,"epsilon"]+1 <= 36){
    ...
    epsilon[[eval[,"epsilon"]+1]]$chi[eval[,"chi"]] * epsilon[[eval[,"epsilon"]+1]]$total / chi[[eval[,"chi"]]]$total))
  }
  ...
  if(is.na(eval[,"epsilon"])){
    ...
    epsilon[[36]]$chi[eval[,"chi"]] * epsilon[[36]]$total / chi[[eval[,"chi"]]]$total))
  }else if(eval[,"epsilon"]-1 >=1){
    amt <- append(amt, c(epsilon[[eval[,"epsilon"]-1]]$alpha[eval[,"alpha"]] * epsilon[[eval[,"epsilon"]-1]]$total / alpha[[eval[,"alpha"]]]$total,
    epsilon[[eval[,"epsilon"]-1]]$beta[eval[,"beta"]] * epsilon[[eval[,"epsilon"]-1]]$total / beta[[eval[,"beta"]]]$total,
    epsilon[[eval[,"epsilon"]-1]]$gamma[eval[,"gamma"]] * epsilon[[eval[,"epsilon"]-1]]$total / gamma[[eval[,"gamma"]]]$total,
  ...
  if(is.na(eval[,"zeta"])){
    ...
    amt <- append(amt, c(zeta[[1]]$alpha[eval[,"alpha"]] * zeta[[1]]$total / alpha[[eval[,"alpha"]]]$total,
                         ...
                         zeta[[1]]$chi[eval[,"chi"]] * zeta[[1]]$total / chi[[eval[,"chi"]]]$total))
  }else if(eval[,"zeta"]+1 <= 36){
    amt <- append(amt, c(zeta[[eval[,"zeta"]+1]]$alpha[eval[,"alpha"]] * zeta[[eval[,"zeta"]+1]]$total / alpha[[eval[,"alpha"]]]$total,
                         ...
                         zeta[[eval[,"zeta"]+1]]$chi[eval[,"chi"]] * zeta[[eval[,"zeta"]+1]]$total / chi[[eval[,"chi"]]]$total))
  }
  ...
  if(is.na(eval[,"zeta"])){
    ...
    amt <- append(amt, c(zeta[[36]]$alpha[eval[,"alpha"]] * zeta[[36]]$total / alpha[[eval[,"alpha"]]]$total,
                         ...
                         zeta[[36]]$chi[eval[,"chi"]] * zeta[[36]]$total / chi[[eval[,"chi"]]]$total))
  }else if(eval[,"zeta"]-1 >=1){
    amt <- append(amt, c(zeta[[eval[,"zeta"]-1]]$alpha[eval[,"alpha"]] * zeta[[eval[,"zeta"]-1]]$total / alpha[[eval[,"alpha"]]]$total,
                         zeta[[eval[,"zeta"]-1]]$beta[eval[,"beta"]] * zeta[[eval[,"zeta"]-1]]$total / beta[[eval[,"beta"]]]$total,
                         zeta[[eval[,"zeta"]-1]]$gamma[eval[,"gamma"]] * zeta[[eval[,"zeta"]-1]]$total / gamma[[eval[,"gamma"]]]$total,
  ...
  if(is.na(eval[,"chi"])){
    amt <- amb
  }else if(eval[,"chi"] +1 >36){
    amt <- append(amt, c(chi[[1]]$alpha[eval[,"alpha"]] * chi[[1]]$total / alpha[[eval[,"alpha"]]]$total,
    chi[[1]]$beta[eval[,"beta"]] * chi[[1]]$total / beta[[eval[,"beta"]]]$total,
    chi[[1]]$gamma[eval[,"gamma"]] * chi[[1]]$total / gamma[[eval[,"gamma"]]]$total,
    chi[[1]]$delta[eval[,"delta"]] * chi[[1]]$total / delta[[eval[,"delta"]]]$total,
    chi[[1]]$epsilon[eval[,"epsilon"]] * chi[[1]]$total / epsilon[[eval[,"epsilon"]]]$total,
    chi[[1]]$zeta[eval[,"zeta"]] * chi[[1]]$total / zeta[[eval[,"zeta"]]]$total))
  }else if(eval[,"chi"]+1 <= 36){
    amt <- append(amt, c(chi[[eval[,"chi"]+1]]$alpha[eval[,"alpha"]] * chi[[eval[,"chi"]+1]]$total / alpha[[eval[,"alpha"]]]$total,
    chi[[eval[,"chi"]+1]]$beta[eval[,"beta"]] * chi[[eval[,"chi"]+1]]$total / beta[[eval[,"beta"]]]$total,
    chi[[eval[,"chi"]+1]]$gamma[eval[,"gamma"]] * chi[[eval[,"chi"]+1]]$total / gamma[[eval[,"gamma"]]]$total,
    chi[[eval[,"chi"]+1]]$delta[eval[,"delta"]] * chi[[eval[,"chi"]+1]]$total / delta[[eval[,"delta"]]]$total,
    chi[[eval[,"chi"]+1]]$epsilon[eval[,"epsilon"]] * chi[[eval[,"chi"]+1]]$total / epsilon[[eval[,"epsilon"]]]$total,
    chi[[eval[,"chi"]+1]]$zeta[eval[,"zeta"]] * chi[[eval[,"chi"]+1]]$total / zeta[[eval[,"zeta"]]]$total))
  ...
  if(is.na(eval[,"chi"])){
    amt <- amb
  }else if(eval[,"chi"]-1 < 1){
    amt <- append(amt, c(chi[[36]]$alpha[eval[,"alpha"]] * chi[[36]]$total / alpha[[eval[,"alpha"]]]$total,
    chi[[36]]$beta[eval[,"beta"]] * chi[[36]]$total / beta[[eval[,"beta"]]]$total,
    chi[[36]]$gamma[eval[,"gamma"]] * chi[[36]]$total / gamma[[eval[,"gamma"]]]$total,
    chi[[36]]$delta[eval[,"delta"]] * chi[[36]]$total / delta[[eval[,"delta"]]]$total,
    chi[[36]]$epsilon[eval[,"epsilon"]] * chi[[36]]$total / epsilon[[eval[,"epsilon"]]]$total,
    chi[[36]]$zeta[eval[,"zeta"]] * chi[[36]]$total / zeta[[eval[,"zeta"]]]$total))
  }else if(eval[,"chi"]-1 >=1){
    amt <- append(amt, c(chi[[eval[,"chi"]-1]]$alpha[eval[,"alpha"]] * chi[[eval[,"chi"]-1]]$total / alpha[[eval[,"alpha"]]]$total,
    chi[[eval[,"chi"]-1]]$beta[eval[,"beta"]] * chi[[eval[,"chi"]-1]]$total / beta[[eval[,"beta"]]]$total,
    chi[[eval[,"chi"]-1]]$gamma[eval[,"gamma"]] * chi[[eval[,"chi"]-1]]$total / gamma[[eval[,"gamma"]]]$total,
